 ...
 * @author thehaohcm
 */
//Su dung trong DNS Server tim trong CSDL hoac gui den Google DNS tra ve cho client
public class miniDNSThread1 implements Runnable,AutoOffInterface{
    ...
    public miniDNSThread1(DNSApplication app, DNSThread mainThread,DatagramSocket socket, byte[] receive, InetAddress ip, int port) {
        this.app = app;
